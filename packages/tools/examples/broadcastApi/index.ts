...
addButtonToToolbar({
  title: 'Sagittal CT to new window',
  onClick: async () => {
    window.open('http://localhost:3000', '_blank', 'popup');
    channel.postMessage('Sagittal Window Created');
  },
});

addButtonToToolbar({
  title: 'Coronal CT to new window',
  onClick: async () => {
    window.open('http://localhost:3000', '_blank', 'popup');
    channel.postMessage('Coronal Window Created');
  },
});
